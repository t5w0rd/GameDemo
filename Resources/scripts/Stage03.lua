...
function spawnHero(id)
    ...
    if atk:getCastRange() > 100 then
        hero:addActiveAbility(AL.kReflect)
        hero:addActiveAbility(AL.kSpeedUp2)
        hero:addActiveAbility(AL.kKnockBack)
        hero:setAI(LuaAI:new())
    else
        hero:addActiveAbility(AL.kThrowHammer)
        hero:addActiveAbility(AL.kThunderCap)
        hero:addActiveAbility(AL.kSpeedUp)
        ...
        if el > 2 then
            ...
            if not hero then
                ...
                if a:getCastRange() < 150 and math.random(0, 100) < 50 then
                    spawnHero(4)
                    hero:addActiveAbility(AL.kCutter)
...
function initAbilityForMe()
    ...
    --me:addActiveAbility(AL.kMultiSlash)
    --me:addActiveAbility(AL.kKnockBackEx)
    me:addActiveAbility(AL.kThrowHammerEx)
    me:addActiveAbility(AL.kWarCry)
	--me:addActiveAbility(AL.kChargeJump)
	
	--me:addPassiveAbility(AL.kPressureBombAttack)
    --me:addPassiveAbility(AL.kDamageIncreaceAttack)
	--me:addPassiveAbility(AL.kArmorBreakAttack)
	
    --me:addPassiveAbility(AL.kVampireAttack)
    --me:addPassiveAbility(AL.kCriticalAttack)
    --me:addPassiveAbility(AL.kRebirth)
    --me:addPassiveAbility(AL.kThunderCapAttack)
    --me:addPassiveAbility(AL.kThrowHammerAttack)
    --me:addPassiveAbility(AL.kCutterAttack)
end
...
function game02()
    ...
    u:addActiveAbility(AL.kThrowHammer)
    ...
    --u:addActiveAbility(AL.kReflect)

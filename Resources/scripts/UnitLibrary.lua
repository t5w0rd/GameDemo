...
loadAnimation("Sprites/Priest/act1", "Sprites/Priest/act1", 0.1)
loadAnimation("Sprites/Priest/act2", "Sprites/Priest/act2", 0.1)
loadAnimation("Sprites/Priest/act3", "Sprites/Priest/act3", 0.1)
loadAnimation("Sprites/Priest/act4", "Sprites/Priest/act4", 0.1)
loadAnimation("Sprites/Priest/act5", "Sprites/Priest/act5", 0.1)
...
sp:prepareAnimation(Sprite.kAniAct1, "act1", 5)
sp:prepareAnimation(Sprite.kAniAct2, "act2", 6)
...
atk = AttackAct:new("¹¥»÷", 1.75, AttackValue.kMagical, 50.0, 0.15, 0.0, 200.0, false, Sprite.kAniAct2)
